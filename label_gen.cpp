...
wxString label_gen::save_pdf_file(wxString s_file)
{
     wxString s_path = wxGetCwd()+wxT("\\temp\\");
     if(!s_file.IsEmpty())
     {
        s_path= s_path+s_file;
           SaveAsFile(s_path);
     }else
     {

         s_path = s_path+wxT("temp.pdf");
         SaveAsFile(s_path);
     }
...
void label_gen::generate_table()
{
 ...
 //   SetFont(wxT("simhei"), wxT("bold") , font_height1);
    Cell(table_width*13/20 , cell_height, m_value.s_project_name,wxPDF_BORDER_TOP|wxPDF_BORDER_RIGHT|wxPDF_BORDER_BOTTOM,0,wxPDF_ALIGN_LEFT |wxPDF_ALIGN_JUSTIFY);
    Cell(table_width/15, cell_height, m_fixed_value.s_wbs, wxPDF_BORDER_TOP|wxPDF_BORDER_LEFT|wxPDF_BORDER_BOTTOM, 0, wxPDF_ALIGN_LEFT);
    //SetFont(wxT("arial"), wxT(""), font_height1);
    Cell(table_width*11/60 , cell_height, m_value.s_wbs,wxPDF_BORDER_TOP|wxPDF_BORDER_RIGHT|wxPDF_BORDER_BOTTOM,0,wxPDF_ALIGN_LEFT |wxPDF_ALIGN_JUSTIFY);
    Ln();

    //第三行

    int i_len = m_value.s_lift_no.Length();
   ...
   //     SetFont(wxT("arial"), wxT(""), font_height3);
    ...
    else
    {
        ...
        Cell(table_width/20, cell_height, m_fixed_value.s_lift_no,wxPDF_BORDER_TOP|wxPDF_BORDER_LEFT|wxPDF_BORDER_BOTTOM,0,wxPDF_ALIGN_LEFT);
    //    SetFont(wxT("arial"), wxT(""), font_height3);
        Cell(table_width/10, cell_height, m_value.s_lift_no,wxPDF_BORDER_TOP|wxPDF_BORDER_RIGHT|wxPDF_BORDER_BOTTOM,0,wxPDF_ALIGN_LEFT);
        SetFont(wxT("simhei"), wxT(""), font_height1);
        Cell(table_width/5, cell_height, m_fixed_value.s_car_weight,wxPDF_BORDER_TOP|wxPDF_BORDER_LEFT|wxPDF_BORDER_BOTTOM,0,wxPDF_ALIGN_LEFT);
        SetFont(wxT("arial"), wxT(""), font_height3);
        Cell(table_width/20, cell_height, m_value.s_car_weight,wxPDF_BORDER_TOP|wxPDF_BORDER_RIGHT|wxPDF_BORDER_BOTTOM,0,wxPDF_ALIGN_LEFT);
    }
    ...
    SetFont(wxT("arial"), wxT(""), font_height3);
    Cell(table_width/4, cell_height, m_value.s_dc_weight,wxPDF_BORDER_TOP|wxPDF_BORDER_RIGHT|wxPDF_BORDER_BOTTOM,0,wxPDF_ALIGN_LEFT);
    SetFont(wxT("simhei"), wxT(""), font_height1);
 /*   Cell(table_width*1/10, cell_height, m_fixed_value.s_rate, wxPDF_BORDER_TOP|wxPDF_BORDER_LEFT|wxPDF_BORDER_BOTTOM ,0,wxPDF_ALIGN_LEFT);
    ...
    //第五行
    Cell(table_width/5, cell_height, m_fixed_value.s_balance_block0_qty, wxPDF_BORDER_FRAME,0, wxPDF_ALIGN_CENTER);
    SetFont(wxT("arial"), wxT(""), font_height3);
    Cell(table_width/5, cell_height, m_value.s_balance_block0_qty, wxPDF_BORDER_FRAME,0, wxPDF_ALIGN_CENTER);
    ...
    Cell(table_width *3/20, cell_height, wxT(""), wxPDF_BORDER_FRAME,0, wxPDF_ALIGN_CENTER);
    Cell(table_width/10, cell_height, wxT(""), wxPDF_BORDER_FRAME,0, wxPDF_ALIGN_CENTER);
    Cell(table_width *3/20, cell_height, wxT(""), wxPDF_BORDER_RIGHT,0, wxPDF_ALIGN_CENTER);
    Ln();

    //第五行
     SetFont(wxT("simhei"), wxT(""), font_height1);
    Cell(table_width/5, cell_height, m_fixed_value.s_rate, wxPDF_BORDER_FRAME,0, wxPDF_ALIGN_CENTER);
    SetFont(wxT("arial"), wxT(""), font_height3);
    Cell(table_width/5, cell_height, m_value.s_rate, wxPDF_BORDER_FRAME,0, wxPDF_ALIGN_CENTER);
    Cell(table_width/5, cell_height, wxT(""), wxPDF_BORDER_FRAME,0, wxPDF_ALIGN_CENTER);
    Cell(table_width *3/20, cell_height, wxT(""), wxPDF_BORDER_FRAME,0, wxPDF_ALIGN_CENTER);
    Cell(table_width/10, cell_height, wxT(""), wxPDF_BORDER_FRAME,0, wxPDF_ALIGN_CENTER);

    SetFont(wxT("simhei"), wxT(""), font_height1);
    Cell(table_width/20, cell_height, m_fixed_value.s_block_material1, wxPDF_BORDER_LEFT,0,wxPDF_ALIGN_LEFT|wxPDF_ALIGN_TOP);
    SetFont(wxT("arial"), wxT(""), font_height3);


    Cell(table_width/10, cell_height, m_value.s_block_material1, wxPDF_BORDER_RIGHT,0,wxPDF_ALIGN_LEFT|wxPDF_ALIGN_TOP);
    ...
    //第六行
    SetFont(wxT("simhei"), wxT(""), font_height1);
    Cell(table_width/5, cell_height*2, m_fixed_value.s_sub_head17, wxPDF_BORDER_FRAME, 0, wxPDF_ALIGN_CENTER);
    ...
    Cell(table_width/20, cell_height, m_fixed_value.s_block_material2, wxPDF_BORDER_LEFT,0,wxPDF_ALIGN_LEFT);
    SetFont(wxT("arial"), wxT(""), font_height3);
    Cell(table_width/10, cell_height, m_value.s_block_material2, wxPDF_BORDER_RIGHT,0,wxPDF_ALIGN_LEFT);
    ...
    Cell(table_width*3/20,cell_height,wxT(""),wxPDF_BORDER_FRAME);
    Cell(table_width/10,cell_height, wxT(""),wxPDF_BORDER_FRAME);
    Cell(table_width *3/20, cell_height, wxT(""), wxPDF_BORDER_RIGHT|wxPDF_BORDER_BOTTOM,0, wxPDF_ALIGN_CENTER);
    Ln();

    wxString str = _("备注：1. 如果铸铁对重块和复合对重块同时配置时，优先安装铸铁对重块。");

    SetFont(wxT("simhei"), wxT(""), font_height3);
    Cell(table_width, cell_height*2, str, wxPDF_BORDER_RIGHT|wxPDF_BORDER_LEFT,0,wxPDF_ALIGN_LEFT);
    Ln();
    Cell(table_width, cell_height*4, _(""), wxPDF_BORDER_RIGHT|wxPDF_BORDER_BOTTOM|wxPDF_BORDER_LEFT,0,wxPDF_ALIGN_LEFT);
/*
    //第八行
    SetFont(wxT("simhei"), wxT(""), font_height1);
